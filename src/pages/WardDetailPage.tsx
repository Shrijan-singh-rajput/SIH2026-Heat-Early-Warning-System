...
const WardDetailPage = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Ward Detail Analysis</h1>
        <p className="text-gray-600">Zone Code: {zoneCode || 'Unknown'}</p>
      </div>

      <div className="bg-white p-6 rounded-lg border border-gray-200">
        <h2 className="text-lg font-medium text-gray-900 mb-4">Ward Profile & Forecast</h2>
