      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{affectedZones}</p>
              <p className="text-xs text-gray-600">of {totalZones} zones affected</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">vulnerable population</p>
            </div>
          </div>
        </div>
      </div>
